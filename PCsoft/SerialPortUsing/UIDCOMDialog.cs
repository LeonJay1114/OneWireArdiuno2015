...
namespace SerialPortUsing {
	...
	class UIDCOMDialog {
		...
		public UIDCOMDialog(string portName, int baudRate, int uIDLength, UIDReceivingHandler receivingHandler) {
			...
			_port = new COMByteSequenceReceiverSender(portName, baudRate, uIDLength + 1, receiver_DataReceived);
		}
		#endregion
		...
		public  void SendCommand(ACCommand command) {
			_port.Send(new []{(byte)command});
		}
		#endregion
	}
